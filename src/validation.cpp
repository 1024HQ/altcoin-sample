...
#if defined(NDEBUG)
# error "edit_namecoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "edit_namecoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s edit_abbreviation additional fees, %d delta bytes\n",
...
CAmount GetBlockSubsidy(int nHeight, const Consensus::Params& consensusParams)
{
	...
	if(nHeight == 1){
        nSubsidy = 1000000 * COIN; // รางวัล blockที่1
    }
