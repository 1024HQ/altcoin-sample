edit_namecoin Core version 0.13.3 is now available from:

  <https://download.2edit_namecoin2.org/2edit_namecoin2-0.13.3/>
...
Developers who require the new testnet blockchain paramaters can find them [here](https://github.com/2edit_namecoin2-project/2edit_namecoin2/blob/0.13/src/chainparams.cpp#L214).
