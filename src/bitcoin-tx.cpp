...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s 2edit_namecoin2-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  2edit_namecoin2-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded 2edit_namecoin2 transaction") + "\n" +
              "  2edit_namecoin2-tx [options] -create [commands]   " + _("Create hex-encoded 2edit_namecoin2 transaction") + "\n" +
              "\n";
