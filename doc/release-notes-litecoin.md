edit_namecoin Core version *0.15.1* is now available from:

  <https://download.2edit_namecoin2.org/2edit_namecoin2-0.15.1/>
...
A number of changes to the way edit_namecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lites per kB (0.00001 edit_abbreviation). This is to prepare for dropping the minimum transaction fee to 0.1 lites per kB (0.0001 edit_abbreviation) in the next release.
